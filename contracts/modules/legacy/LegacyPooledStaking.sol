...
contract LegacyPooledStaking is IPooledStaking, MasterAwareV2 {
  ...
  */
  ...
  function getV1PriceForProduct(uint id) pure public returns (uint96) {
    ...
    if (id == 0) {
      return 16690889329391747000; // 16.690889329391748 %
    }
    ...
    if (id == 2) {
      return 20893679995326226000; // 20.893679995326227 %
    }

    // 0x11111254369792b2Ca5d084aB5eEA397cA8fa48B
    if (id == 6) {
      return 12202431416749345000; // 12.202431416749345 %
    }

    // 0x5B67871C3a857dE81A1ca0f9F7945e5670D986Dc
    if (id == 9) {
      return 27241547115029710000; // 27.241547115029707 %
    }

    // 0xAFcE80b19A8cE13DEc0739a1aaB7A028d6845Eb3
    if (id == 11) {
      return 5043481739231990000; // 5.04348173923199 %
    }

    // 0xa4c8d221d8BB851f83aadd0223a8900A6921A349
    if (id == 13) {
      return 5513433496583270000; // 5.5134334965832705 %
    }

    // 0xA51156F3F1e39d1036Ca4ba4974107A1C1815d1e
    if (id == 16) {
      return 36502438306598320000; // 36.50243830659832 %
    }

    // 0x6354E79F21B56C11f48bcD7c451BE456D7102A36
    if (id == 17) {
      return 16399680457462840000; // 16.39968045746284 %
    }
    ...
    if (id == 20) {
      return 26322202290081755000; // 26.322202290081755 %
    }

    // 0x8481a6EbAf5c7DABc3F7e09e44A89531fd31F822
    if (id == 26) {
      return 9057734050615371000; // 9.057734050615371 %
    }

    // 0xc57D000000000000000000000000000000000008
    if (id == 28) {
      return 2623372359705078000; // 2.6233723597050775 %
    }

    // 0xc57d000000000000000000000000000000000009
    if (id == 29) {
      return 2929729150713489400; // 2.9297291507134893 %
    }
    ...
    if (id == 34) {
      return 2623442888964171300; // 2.6234428889641714 %
    }

    // 0x0000000000000000000000000000000000000010
    if (id == 35) {
      return 3548015124659830000; // 3.54801512465983 %
    }
    ...
    if (id == 50) {
      return 53043202907859780000; // 53.04320290785978 %
    }
  ...
  function migrateToPool(
    ...
    if (tokenId != 0) {
      stakingNFT.transferFrom(address(this), migrationData.managerAddress, tokenId);
    }
